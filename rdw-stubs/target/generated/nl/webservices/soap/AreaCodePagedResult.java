...
/**
 * <p>Java class for AreaCodePagedResult complex type.
 * 
...
@XmlType(name = "AreaCodePagedResult", propOrder = {

})
public class AreaCodePagedResult {

    @XmlElement(required = true)
    protected ResultInfo paging;
    @XmlElement(required = true)
    protected AreaCodeArray results;
     ...
     *     
     */
    public AreaCodeArray getResults() {
        return results;
    }
     ...
     *     
     */
    public void setResults(AreaCodeArray value) {
        this.results = value;
    }
