...
/**
 * <p>Java class for Perceel complex type.
 * 
...
@XmlType(name = "Perceel", propOrder = {

})
public class Perceel {

    protected int perceelid;
    protected int huisnr;
    @XmlElement(name = "huisnr_toevoeging", required = true)
    ...
    /**
     * Gets the value of the perceelid property.
     * 
     */
    public int getPerceelid() {
        return perceelid;
    }

    /**
     * Sets the value of the perceelid property.
     * 
     */
    public void setPerceelid(int value) {
        this.perceelid = value;
    }
