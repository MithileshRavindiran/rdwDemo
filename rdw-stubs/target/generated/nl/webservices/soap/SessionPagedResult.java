...
/**
 * <p>Java class for SessionPagedResult complex type.
 * 
...
@XmlType(name = "SessionPagedResult", propOrder = {
...
public class SessionPagedResult {
    ...
    @XmlElement(required = true)
    protected SessionArray results;
     ...
     *     
     */
    public SessionArray getResults() {
        return results;
    }
     ...
     *     
     */
    public void setResults(SessionArray value) {
        this.results = value;
    }
